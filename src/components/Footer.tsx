...
import { personalInfo, navigationItems } from '../lib/data'

/**
 * Footer 컴포넌트 - 지도 기반 프론트엔드 개발자 포트폴리오
 * 
 * 주요 기능:
 * - 소셜 미디어 링크
 * - 연락처 정보
      ...
      <div className="container mx-auto px-4 py-16">
          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <a href={`mailto:${personalInfo.email}`} className="text-gray-300 hover:text-primary transition-colors duration-300">
                  {personalInfo.email}
                </a>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <a href={`tel:${personalInfo.phone}`} className="text-gray-300 hover:text-primary transition-colors duration-300">
                  {personalInfo.phone}
                </a>
              </div>
              <div className="flex items-start space-x-3">
        ...
        >
          <p className="text-gray-400">
            ...
            <br />
            Made with ❤️ for mapping and spatial data visualization.
          </p>
        </motion.div>
      </div>
    </footer>
